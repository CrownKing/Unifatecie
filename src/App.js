...
function App() {
  ...
  function abrirWhatsApp() {
    const numero = "992555623"; // Substitua 'SEU_NUMERO' pelo número do WhatsApp
    const mensagem = "Olá! Tenho muito interesse em estudar na UniFatecie!!!"; // Mensagem pré-definida a ser enviada
    window.open(
  ...
  useEffect(() => {
    ...
    // Cria um elemento <script> para carregar a API do YouTube
    ...
    window.onYouTubeIframeAPIReady = () => {
      new window.YT.Player("player", {
        width: "100%",
        height: "100%",
        videoId: "jMxaq-w6iMk", // ID do vídeo do YouTube
      });
    };
      ...
      <nav className="navBar flexDirectionRow displayFlex">
        ...
        <div className="displayFlex alignItemsCenter flexDirectionColumn justifyContentCenter divWpp">
          ...
          <span style={{ whiteSpace: "nowrap" }}>
            <a
              className="anchor"
              href="https://api.whatsapp.com/send?phone=5544991720841&text=Olá, quero aproveitar a oferta na Graduação Ead UNIFATECIE."
            >
      ...
      <section className="container textAlignCenter">
        ...
        <section className="container" id="list-courses">
          <div className="options">
            <div className="colItem ">
              <div id="accordion">
                <a href="#" className="anchorCursos" data-target="#bacharelado">
                  <div
                          ...
                          <div className="conteudo">
                            ...
                            <p className="botao">
                              ...
                              >
                                ...
                                <i
                                  class="fa-solid fa-circle-chevron-right ml-3"
                                  aria-hidden="true"
                                ></i>
                              </a>
                            </p>
                          ...
                          <div className="conteudo">
                            <p>
                              ...
                              >
                                <b>
                                  Economia{" "}
                                  <span className="textHighlight">3 Anos</span>{" "}
                                  <FontAwesomeIcon icon={faCircleInfo} />
                                </b>
                              </a>
                            </p>
                        ...
                        <li>
                          <p>
                            ...
                            >
                              <b>
                                Biomedicina{" "}
                                <span className="textHighlight">3.5 Anos</span>{" "}
                                <FontAwesomeIcon icon={faCircleInfo} />
                              </b>
                            </a>
                          </p>
            ...
            <div className="colItem ">
              <div id="accordion">
                <a href="#" className="anchorCursos" data-target="#bacharelado">
                  <div className="textAlignLeft titulolista displayFlex alignItemsCenter textColorWhite">
                        ...
                        <li>
                          <p>
                            ...
                            >
                              <b>
                                Processos Químicos{" "}
                                <span className="textHighlight">2.5 Anos</span>{" "}
                                <FontAwesomeIcon icon={faCircleInfo} />
                              </b>
                            </a>
                          </p>
                        ...
                        <li>
                          <p>
                            ...
                            >
                              <b>
                                Secretario Executivo{" "}
                                <span className="textHighlight">1.5 Anos</span>{" "}
                                <FontAwesomeIcon icon={faCircleInfo} />
                              </b>
                            </a>
                          </p>
            ...
            <div className="textMec">
              ...
              <div className="missaoDiv">
                ...
                <span>
                  ...
                  consolidado no ensino nos seus diversos níveis e modalidades,
                  atendendo aos nossos.
                </span>
              </div>
              <br></br>
              <div className="missaoDiv">
        ...
        <section className="motivosSection">
          <div className="motivosSectionHeader">
            <span>
              A UniFatecie tem tudo que você precisa para alavancar nos estudos
            </span>
          </div>
          <div className="motivosDiv">
            <div className="motivosDivImg">
              ...
              <span>
                Cursos de Graduação EaD, com início imediato, conclusão a partir
                de 18 meses, instituição nota máxima junto MEC.
              </span>
            </div>
            <div className="motivosDivImg">
            ...
            <div className="motivosDivImg">
              ...
              <span>
                ...
                multiplataforma de aprendizagem, em que você poderá assistir às
                aulas pelo seu celular, tablet ou computador. Onde, como e
        ...
        <section>
          <div className="bgForms">
            <div className="formsInputs">
              ...
              <span>Telefone</span>
              <input placeholder="(DDD) + Telefone"></input>
